...
| :--- | :--- | :--- | :--- | :--- |
| 11 | FER_TEST | ⚠️ Cerrado Local/Git (Bloqueo Cloud) | Saneamiento forense y reescritura del historial Git de fer_test publicado en origin/fer_test con force-with-lease (commit be05728). a866551 ya no es alcanzable, backup eliminado, working tree limpio, init_v8.sql intacto respecto a bbca07c. Suite pasando al 100% (Vitest: 87/0/1, Playwright: 1/0). Acciones externas bloqueadas por falta de acceso operativo/administrativo a Supabase Cloud: rotación de credenciales de prueba y aplicación de migración RLS en Cloud (operando vía fallback). | N/A |
